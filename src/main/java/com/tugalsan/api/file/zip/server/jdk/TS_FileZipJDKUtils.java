...
public class TS_FileZipJDKUtils {
    ...
    @Deprecated
    public static TGS_UnionExcuseVoid zipDirectory(Path sourceDirectory, Path targetZipFile) {
    ...
    public static TGS_UnionExcuseVoid zipFiles(Path[] sourceFiles, Path targetZipFile) {
    ...
    private static TGS_UnionExcuseVoid zipFiles_for(Path sourceFile, ZipOutputStream zos) {
        try {//I KNOW
    ...
    @Deprecated
    public static TGS_UnionExcuseVoid unzipFile(Path zipFile, Path targetDirectory) {
    ...
    @Deprecated
    public static TGS_UnionExcuseVoid unzipURL(URL zipURL, Path targetDirectory) {
